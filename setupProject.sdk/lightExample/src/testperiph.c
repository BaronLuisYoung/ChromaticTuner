...
int main () 
{
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for axi_gpio_rbg_led...\r\n");

      status = GpioOutputExample(XPAR_AXI_GPIO_RBG_LED_DEVICE_ID,6);
...

   {
      ...
      print("\r\nRunning GpioInputExample() for Encoder...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_ENCODER_DEVICE_ID, &DataRead);
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &Encoder_Gpio, \
