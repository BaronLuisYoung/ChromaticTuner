...
void gpio_handler(void) {
	...
	if (ButtonStatus == 0x04) {
		QActive_postISR((QActive*) (&AO_Lab2A), BUTTON1);
	} else if (ButtonStatus == 0x02) {
		QActive_postISR((QActive*) (&AO_Lab2A), BUTTON2);
	} else if (ButtonStatus == 0x10) {
		QActive_postISR((QActive*) (&AO_Lab2A), BUTTON3);
	} else if (ButtonStatus == 0x01) {
		QActive_postISR((QActive*) (&AO_Lab2A), BUTTON4);
	} else if (ButtonStatus == 0x08) {
		QActive_postISR((QActive*) (&AO_Lab2A), BUTTON5);
	}
