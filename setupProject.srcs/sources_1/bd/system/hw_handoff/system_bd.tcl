...
# module references:
# nopll_mic_block, stream_grabber
...
proc create_hier_cell_mic_block { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_mic_block() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  set jdport [ create_bd_port -dir I -from 2 -to 0 jdport ]
  ...
  # Create instance: axi_gpio_rbg_led, and set properties
  set axi_gpio_rbg_led [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_rbg_led ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_rbg_led/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net axi_gpio_rbg_led_gpio_io_o [get_bd_ports rgbleds] [get_bd_pins axi_gpio_rbg_led/gpio_io_o]
  ...
  connect_bd_net -net btnCpuReset [get_bd_ports btnCpuReset] [get_bd_ports reset_spi] [get_bd_pins mig_7series_0/sys_rst]
  ...
  connect_bd_net -net gpio_io_i_0_2 [get_bd_ports jdport] [get_bd_pins Encoder/gpio_io_i]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins Encoder/s_axi_aresetn] [get_bd_pins axi_gpio_btn/s_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_rbg_led/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins mic_block/sys_rst] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/M10_ARESETN] [get_bd_pins microblaze_0_axi_periph/M11_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins sevenSeg_0/s00_axi_aresetn] [get_bd_pins spi/s_axi_aresetn] [get_bd_pins spi_dc/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Encoder/S_AXI/Reg] SEG_Encoder_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_rbg_led/S_AXI/Reg] SEG_axi_gpio_rbg_led_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs mic_block/stream_grabber_0/s_axi_cpu/reg0] SEG_stream_grabber_0_reg0
